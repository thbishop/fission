module Fission
  module Action
    ...
    class VMDeleter
      ...
      # If the Fusion GUI is running this method should succeed, but it's been
      # observed that Fusion will recreate the plist data which is deleted.
      # This leads to 'missing' VMs in the Fusion GUI.
      #
      # Examples
      #
      #   @deleter.delete

...
require 'fission/action/vm_cloner'
require 'fission/action/vm_deleter'
require 'fission/action/vm_starter'
require 'fission/action/vm_stopper'
require 'fission/action/vm_suspender'
require 'fission/cli'
